...
#create items
Item.create(name: "Remy Martin XO Limited Edition Bottle | 750 ml", alcohol_type: "Cognac", price: 169.0, inventory: 0, abv: 40, origin: "France 🇫🇷", description: "Remy Martin XO is a masterful blend of over 400 eaux-de-vie from the two finest-quality vineyards of Cognac and aged up to 30 years in French oak casks. Aromatic, opulent and velvety, with a wide spectrum of stone fruit notes, hints of hazelnut and cinnamon.")
